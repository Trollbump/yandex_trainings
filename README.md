...
- [Тренировки 3.0](#training3)
    - [1. Гистограмма](#n3.01)
    - [2. Красивая строка](#n3.02)
    - [3. Коллекционер Диего](#n3.03)
    - [4. Контрольная работа](#n3.04)
    - [5. Хорошая строка](#n3.05)
    - [6. Операционные системы lite](#n3.06)
    - [7. SNTP](#n3.07)
    - [8. Минимальный прямоугольник](#n3.08)
    - [10. Скучная лекция](#n3.10)
...
### 2. Красивая строка <a name="n3.02"></a> 
...
Во второй строке дана непустая строчка S (|S| ≤ 2 ⋅ 10<sup>5</sup>).  
...
### 5. Хорошая строка <a name="n3.05"></a> 
...
|Ввод               |Вывод                |
|-------------------|---------------------|
|3<br/>1<br/>1<br/>1|2<br/><br/><br/><br/>|

#### Пример 2

|Ввод         |Вывод           |
|-------------|----------------|
|2<br/>3<br/>4|3<br/><br/><br/>|

[Ссылка на код](training3.0/05_good_string.py)  

[Вернуться к содержанию](#contents)

---

### 6. Операционные системы lite <a name="n3.06"></a> 
...
|Ввод                            |Вывод                     |
|--------------------------------|--------------------------|
|10<br/>3<br/>1 3<br/>4 7<br/>3 4|1<br/><br/><br/><br/><br/>|

#### Пример 2

|Ввод                                    |Вывод                          |
|----------------------------------------|-------------------------------|
|10<br/>4<br/>1 3<br/>4 5<br/>7 8<br/>4 6|3<br/><br/><br/><br/><br/><br/>|

[Ссылка на код](training3.0/06_os.py)  

[Вернуться к содержанию](#contents)

---

### 7. SNTP <a name="n3.07"></a> 
...
Программа должна вывести одну временную метку в формате, описанном во входных данных, – вычисленное точное время для установки на клиенте.  
...
|Ввод                              |Вывод                  |
|----------------------------------|-----------------------|
|15:01:00<br/>18:09:45<br/>15:01:40|18:10:05<br/><br/><br/>|

[Ссылка на код](training3.0/07_sntp.py)  

[Вернуться к содержанию](#contents)

---

### 8. Минимальный прямоугольник <a name="n3.08"></a> 
...
На следующих K строках находятся пары чисел X<sub>i</sub> и Y<sub>i</sub> – координаты закрашенных клеток (|X<sub>i</sub>|, |Y<sub>i</sub>| ≤ 10<sup>9</sup>).  
...
|Ввод                      |Вывод                       |
|--------------------------|----------------------------|
|3<br/>1 1<br/>1 10<br/>5 5|1 1 5 10<br/><br/><br/><br/>|

[Ссылка на код](training3.0/08_minimal_rectangle.py)  

[Вернуться к содержанию](#contents)

---

### 10. Скучная лекция <a name="n3.10"></a> 
...
|Ввод                     |Вывод                           |
|-------------------------|--------------------------------|
|hello<br/><br/><br/><br/>|e: 8<br/>h: 5<br/>l: 17<br/>o: 5|

#### Пример 2

|Ввод                  |Вывод                    |
|----------------------|-------------------------|
|abacaba<br/><br/><br/>|a: 44<br/>b: 24<br/>c: 16|

[Ссылка на код](training3.0/10_boring_lecture.py)  
